...
\begin{figure}[t]
  ...
  \caption{The full served frame, before (top) and after (bottom) correction ---
  2026-07-25 19:15 EDT, reprocessed through the production chain (the ``after'' is the
  frame now installed in the public archive). The blemish is the dark smudge in the sky
  left of centre in the top image; everything else, including the faint cloud structure
  and the crane at far left, is untouched. Figure~\ref{fig:ba} shows the same
  correction at pixel scale.}
  \label{fig:full}
\end{figure}
