...
\begin{abstract}
\noindent
Every camera that looks through glass eventually encounters a speck of dirt. A
0.25-millimetre grain on a window in Porter Hall at Carnegie Mellon University,
three centimetres before the $f/4$ pupil of a sky monitor, prints a 76-pixel shadow
on every image --- and, measured
...
millimetres of sash flexure; the grain never moves. These measurements are an
independent terrestrial replication of the dust-shadow optics developed for the Mars
rovers' cameras --- validated there at nearly our particle-to-pupil regime --- and
extend that model with per-channel photometry and continuous tracking. To our knowledge
