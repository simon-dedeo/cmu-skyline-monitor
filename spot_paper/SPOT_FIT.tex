...
\begin{abstract}
\noindent
A 0.25-millimetre grain on a window in Porter Hall at Carnegie Mellon, three
centimetres before a sky monitor's $f/4$ pupil, is a single-particle optics
experiment in disguise. Its 76-pixel shadow matches the grain's projected area
(4.5--5.4 per cent against 5.2), excluding the extinction paradox's factor of two;
recollected blue scatter predicts the green channel from blue and red alone; and
the 92 pixel-per-millimetre geometry resolves 1.3 millimetres of sash flexure ---
the grain never moves. The measurements independently replicate the Mars rovers'
dust-shadow optics, adding per-channel photometry and continuous tracking; to our
knowledge no prior work continuously tracks the position of a single adherent
occluder migrating across the optic. An autonomous Bayesian pipeline erases the
artifact (median dip 4.5 to 0.5 per cent; live at
\href{https://proofsandreasons.io}{proofsandreasons.io}) --- a physics-first
alternative for self-driving cars' soiled, distrusted cameras.
\end{abstract}
