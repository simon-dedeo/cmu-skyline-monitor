...
\begin{center}
  ...
  \SI{-0.2}{\percent} (nulled to within measurement noise). The corrected fusion is
...
\begin{figure}[t]
  ...
  closed-loop gain, frequency-split cap):
  \SI{5.46}{\percent} $\rightarrow$ \SI{-0.2}{\percent}. The difference (right,
