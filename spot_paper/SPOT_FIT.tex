...
$\tilde T$ feathered to unity outside the footprint. There is deliberately \emph{no
...
deeper-and-narrower red at constant integral is the speck itself: micron-scale surface
texture scatters short wavelengths at small angles, and scattered blue that stays within
the pupil's acceptance re-enters the bundles --- refilling the shadow core (blue
shallower), feathering its skirt (blue wider, by $\sim\SI{30}{\micro m}$ at the pane),
and slightly lowering the blue integral, exactly as measured. Red, barely scattered,
casts the cleanest geometric shadow. The blur-invariant total extinction remains
