...
\begin{figure}[t]
  ...
  through the same production chain (registered map, template lock, closed-loop gain):
  \SI{5.46}{\percent} $\rightarrow$ \SI{0.77}{\percent}. The difference (right,
  $6\times$) is a single compact blob; nothing outside the footprint is touched.}
  \label{fig:ba}
\end{figure}
